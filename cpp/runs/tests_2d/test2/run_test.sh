...
python make_input_data_files_test2.py
...
#$mpiexec_petsc -np 6 valgrind --tool=memcheck -q --num-callers=20 --leak-check=full --log-file=valgrind.log.%p $petsc_solver $petsc_inputfile
