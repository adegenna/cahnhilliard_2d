...
PetscReal compute_residuals_no_explicit_boundary_resets( PetscReal*** uarray , PetscReal*** u_none , PetscReal rhs_ijk , PetscReal udot_ijk , PetscInt Mx , PetscInt My , PetscInt Mz , PetscInt i , PetscInt j , PetscInt k ) {
